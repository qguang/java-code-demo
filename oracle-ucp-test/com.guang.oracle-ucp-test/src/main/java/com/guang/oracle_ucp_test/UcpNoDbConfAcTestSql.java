...
public class UcpNoDbConfAcTestSql {
	...
	public void displayEmpList() {
		...
		System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  Test Application (JDBC: configured)(DB: not configured) !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
		try 
		{
	...
	public static void main(String[] args) {
		...
		final UcpNoDbConfAcTestSql empJDBCTemplate = (UcpNoDbConfAcTestSql) context.getBean("UcpNoDbConfAcTestSql");
