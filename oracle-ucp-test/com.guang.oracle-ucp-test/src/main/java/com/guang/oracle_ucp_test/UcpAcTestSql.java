...
public class UcpAcTestSql {
	...
	public void displayEmpList() {
		...
		System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  Test Application (JDBC: configured)(DB: configured) !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
		try 
		{
	...
	public static void main(String[] args) {
		...
		final UcpAcTestSql empJDBCTemplate = (UcpAcTestSql) context.getBean("UcpAcTestSql");
